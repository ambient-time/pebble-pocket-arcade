...
rows = [
    ...
    ('pocket-artillery', 'Pocket Artillery', 'The preferred artillery game: trade tank shots across a crumbling hillside.', 'A few minutes', 'aim'),
